...
that imports Zod schemas from ``@gp-sphinx/astro`` and registers
...
import { documentSchema } from '@gp-sphinx/astro/schemas/doctree'
import { symbolSchema } from '@gp-sphinx/astro/schemas/symbol'
import { xrefEntrySchema } from '@gp-sphinx/astro/schemas/xref'
