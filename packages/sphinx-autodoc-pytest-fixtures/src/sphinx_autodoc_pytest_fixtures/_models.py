"""Data models, dataclasses, protocols, and node types for sphinx_autodoc_pytest_fixtures."""
...
class FixtureMeta:
    ...
    Stored at ``env.domaindata["sphinx_autodoc_pytest_fixtures"]["fixtures"][canonical_name]``.
    """
