...
from gp_sphinx.ext.argparse.neo.utils import escape_rst_emphasis
...
class ArgparseRenderer:
    ...
    Examples
    --------
    >>> from gp_sphinx.ext.argparse.neo.parser import ParserInfo
    >>> config = RenderConfig()
    ...
    def render_group_section(
        ...
        Examples
        --------
        >>> from gp_sphinx.ext.argparse.neo.parser import ArgumentGroup
        >>> renderer = ArgparseRenderer()
        >>> group = ArgumentGroup(
